...
function loadModel(url) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            names = ["Austria","Slovenia","Croatia","Serbia","Macedonida"];
...
$.ajax({
    dataType: "json",
    url: "https://proxy.hxlstandard.org/data.json?strip-headers=on&url=https%3A//docs.google.com/spreadsheets/d/1uQBqfqxqqEYbueJFJg9coqViRlBWK9aAeSeBvuzbEGM/edit%23gid%3D0",
    success: function(data) {
